...
public class Coffeestor {
    public static void main(String[] args) {
        ...
        while(true){
            System.out.printf("\n[INFO] 현제 잔액 : %d \n", coffeeM.money);
            System.out.println("1.제품등록 2.제품목록 3.제품삭제 4.입급 5.출금 6.판매 7.종료");
